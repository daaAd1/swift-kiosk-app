              ...
              <div className="space-y-2">
                  ...
                  <div key={rowIndex} className="flex justify-center space-x-2">
                    {row.map((key) => (
                      <button
                        ...
                        className="w-14 h-10 bg-card border border-border rounded hover:bg-accent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-foreground font-medium text-base"
                      >
                        {key}
                      </button>
                    ))}
                ...
                <div className="flex justify-center mt-2">
                  <button
                    ...
                    className="px-4 h-10 bg-primary text-primary-foreground border border-primary rounded hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium text-base"
                  >
                    @gmail.com
                  </button>
                </div>
